...
export const CANVAS_SKILLS: CanvasSkill[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '',
      '## Two stances (your brief tells you which)',
      '- **Partner (attended)** — your brief says to plan WITH the human. Have a real',
      '  conversation first: ask what they want, the constraints, what "done" looks',
      '  like; draw it out and reflect it back. Write the plan only once you understand',
      '  it, and CONFIRM it with the human before you `approve_plan`.',
      '- **Autonomous (unattended)** — your brief is a complete spec; work from it',
      '  without asking. Your self-audit is the only gate before you deliver.',
      '',
      '## Flow',
