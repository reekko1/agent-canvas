...
const api: CanvasApi = {
  ...
  startAgent: (cardId, folder, cli) => ipcRenderer.invoke('start-agent', cardId, folder, cli),
  ensureShell: (cardId, folder, cols, rows) =>
    ipcRenderer.invoke('ensure-shell', cardId, folder, cols, rows),
  sendToCard: (cardId, text) => ipcRenderer.invoke('send-to-card', cardId, text),
  interruptCard: (cardId) => ipcRenderer.send('interrupt-card', cardId),
  loadTranscript: (cardId) => ipcRenderer.invoke('load-transcript', cardId),
  listSkills: () => ipcRenderer.invoke('list-skills'),
  searchFiles: (folder) => ipcRenderer.invoke('search-files', folder),
  listModels: (cardId) => ipcRenderer.invoke('list-models', cardId),
  setCardModel: (cardId, model) => ipcRenderer.send('set-card-model', cardId, model),
  ...
  onTranscriptItem: (cb) => subscribe('transcript-item', cb),
  onSessionEnded: (cb) => subscribe('session-ended', cb),
  shellTitle: (cardId) => ipcRenderer.invoke('shell-title', cardId),
