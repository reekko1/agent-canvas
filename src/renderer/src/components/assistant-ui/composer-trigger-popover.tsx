...
const ComposerTriggerPopoverImpl: FC<ComposerTriggerPopoverProps> = ({
  ...
  return (
    <ComposerPrimitive.Unstable_TriggerPopover
      ...
      className={cn(
        "aui-composer-trigger-popover bg-popover text-popover-foreground absolute start-0 bottom-full z-50 mb-2 max-h-[min(20rem,60vh)] w-64 overflow-y-auto overscroll-contain rounded-xl border shadow-lg",
        className,
      )}
      {...props}
    >
